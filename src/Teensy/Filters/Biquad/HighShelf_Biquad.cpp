...
void HighShelf_Biquad::updateCoeffs() {
...
void HighShelf_Biquad::setGain(float gainDB) { // dB, [-24.0, 24.0]
...
HighShelf_Biquad::HighShelf_Biquad(float cutoff, float q, float gainDB) {
