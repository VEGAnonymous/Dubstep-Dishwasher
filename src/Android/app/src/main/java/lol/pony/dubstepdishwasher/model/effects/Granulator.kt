...
class Granulator(id: Int) : Effect() {
    ...
    override val parameters = mutableListOf<EffectParameter<*>>(
        ...
        EffectParameter.Range(id = 1, name = "Position", unit = ParamUnit.DIMENSIONLESS, range = 0.0f to 1.0f, exp = 1f, step = 0.01f, initialValue = 0.5f),
        EffectParameter.Range(id = 2, name = "Position Random", unit = ParamUnit.PERCENT, range = 0.0f to 1.0f, exp = 1f, step = 0.01f, initialValue = 0.5f),
        EffectParameter.Range(id = 3, name = "Rate", unit = ParamUnit.MS, range = 1.0f to 500.0f, exp = 2f, step = 1.0f, initialValue = 50.0f),
