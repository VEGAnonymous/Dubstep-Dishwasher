...
class Granulator(id: Int) : Effect() {
    ...
    override val parameters = mutableListOf<EffectParameter<*>>(
        ...
        EffectParameter.Range(id = 7, name = "Tune", unit = ParamUnit.SEMITONES, range = -24.0f to 24.0f, exp = 1f, step = 0.01f, value = 0.0f),
        EffectParameter.Range(id = 8, name = "Tune Random", unit = ParamUnit.PERCENT, range = 0.0f to 1.0f, exp = 1f, step = 0.01f, value = 0.0f),
        EffectParameter.Range(id = 9, name = "Level", unit = ParamUnit.PERCENT, range = 0.0f to 1.0f, exp = 1f, step = 0.01f, value = 0.8f),
        EffectParameter.Range(id = 10, name = "Level Random", unit = ParamUnit.PERCENT, range = 0.0f to 1.0f, exp = 1f, step = 0.01f, value = 0.0f),
        EffectParameter.Range(id = 11, name = "Reverse Chance", unit = ParamUnit.PERCENT, range = 0.0f to 1.0f, exp = 1f, step = 0.01f, value = 0.0f),
        EffectParameter.Discrete(id = 12, name = "Envelope", unit = ParamUnit.ENUM, possibleValues = EnvelopeType.entries.toList(), value = EnvelopeType.HANN)
    )
}