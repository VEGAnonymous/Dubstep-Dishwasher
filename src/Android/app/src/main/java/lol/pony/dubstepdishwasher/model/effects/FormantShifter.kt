...
class FormantShifter(id: Int) : Effect() {
    ...
    override val parameters = mutableListOf<EffectParameter>(
        ...
        EffectParameter.Discrete(effectId = id, id = 1, name = "FFT Size", unit = ParamUnit.DIMENSIONLESS, possibleValues = FFTSize.entries.toList(), initialValue = FFTSize.SIZE_1024),
