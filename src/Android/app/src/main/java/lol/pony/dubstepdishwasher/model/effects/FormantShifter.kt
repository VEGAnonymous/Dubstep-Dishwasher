...
class FormantShifter(id: Int) : Effect() {
    ...
    override val parameters = mutableListOf<EffectParameter<*>>(
        ...
        EffectParameter.Range(effectId = id, id = 3, name = "Envelope Width", unit = ParamUnit.DIMENSIONLESS, range = 0 to 16, exp = 1f, step = 1, initialValue = 16, isModulatable = false)
    )
}