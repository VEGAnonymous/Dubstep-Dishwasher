...
class Vocoder(id: Int) : Effect() {
    ...
    override val parameters = mutableListOf<EffectParameter<*>>(
        ...
        EffectParameter.Range(effectId = id, id = 1, name = "Bands", unit = ParamUnit.DIMENSIONLESS, range = 4 to 20, exp = 1f, step = 1, initialValue = 10, isModulatable = false),
        ...
        EffectParameter.Range(effectId = id, id = 6, name = "Attack", unit = ParamUnit.MS, range = 10.0f to 2000.0f, exp = 2.5f, step = 0.1, initialValue = 20.0f),
