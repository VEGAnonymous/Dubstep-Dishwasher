...
class Parallel(id: Int) : Effect() {
    ...
    override val parameters = mutableListOf<EffectParameter<*>>(
        ...
        EffectParameter.Discrete(id = 1, name = "Mode", unit = ParamUnit.ENUM, possibleValues = ParallelMode.entries.toList(), initialValue = ParallelMode.SUM),
        // TODO: Addressing and routing logic for internal chain effects and parameters
    )
}