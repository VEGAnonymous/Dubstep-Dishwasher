...
class Compressor(id: Int) : Effect() {
    ...
    override val parameters = mutableListOf<EffectParameter<*>>(
        ...
        EffectParameter.Range(id = 1, name = "Threshold", unit = ParamUnit.DB, range = -200.0f to 0.0f, exp = 2f, step = 0.1f, value = -18.0f),
        EffectParameter.Range(id = 2, name = "Ratio", unit = ParamUnit.DIMENSIONLESS, range = 1.0f to 100.0f, exp = 2f, step = 0.01f, value = 4.0f),
        EffectParameter.Range(id = 3, name = "Knee", unit = ParamUnit.DIMENSIONLESS, range = 0.0f to 40.0f, exp = 2f, step = 0.1f, value = 10.0f),
