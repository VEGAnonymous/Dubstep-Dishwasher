...
class Phaser(id: Int) : Effect() {
    ...
    override val parameters = mutableListOf<EffectParameter<*>>(
        ...
        EffectParameter.Range(id = 2, name = "Center", unit = ParamUnit.HZ, range = 0.0f to 1.0f, exp = 2f, step = 0.01f, value = 600.0f),
        EffectParameter.Range(id = 3, name = "Spread", unit = ParamUnit.PERCENT, range = 0.0f to 1.0f, exp = 1f, step = 0.01f, value = 1.0f),
